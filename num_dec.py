...
# by an SR engine such as the one in Dragon. Libraries similar to this
# one already exist; but all of the ones I have found were either
# closed source or lacked the features that I was looking for.
#
#+TESTING & QUALITY --------------------------------------------------
#
# The API methods were tested for the first 1 billion integers with
# the chunk size ranging between -4 and 1. An example should make
# the meaning of 'chunk size' clear.
#
# EXAMPLE: Convert the decimal 123456 to numerals using (a) a chunk
# size of 4 and (b) a chunk size of -4.
#
# Solution:
...
#
# Converting decimals to numerals by chunking from left to right is
# not always invertible, since 970053->9700,53->ninety seven hundred
# fifty three->9753. Curiously chunking from right to left works:
